				...
				<div id="board">
					<div id="modifyForm">
						<form action="${pageContext.request.contextPath}/board/modify" method="get">
							...
							<!-- 제목 -->
							<div class="form-group">
								<label class="form-text" for="txt-title">제목</label> <input type="text" id="txt-title" name="" value="${BoardVo.title}">
							</div>
							...
							<!-- 내용 -->
							<div class="form-group">
								<textarea id="txt-content" name="" >${BoardVo.content}</textarea>
							</div>
